...
const Todolist = (showCard) => {
    ...
    return ( <
        div className = "todolistContainer" > { erro && < div className = "erro" > < p > Erro: uma ou mais lacunas estão vazia < /p></div > } <
        div >
        <
        ...
        <
        button onClick = { salvarNoBanco } > Adicionar < /button> <
        /div>
